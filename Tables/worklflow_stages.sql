CREATE TABLE workflow_stages (
    ...
    CONSTRAINT fk_wfstage_workflow FOREIGN KEY (workflow_id) REFERENCES workflows(workflow_id) ON DELETE CASCADE,
    CONSTRAINT fk_wfstage_dept FOREIGN KEY (dept_id) REFERENCES departments(dept_id),
